#ifndef LEMBALL_VISOS_TARGET_UI_CTEXTWND_H
#define LEMBALL_VISOS_TARGET_UI_CTEXTWND_H
...
class CTextWnd : public CCritical {
public:
	CTextWnd(const char* p_title, int p_lineCapacity);
	~CTextWnd();
	void PostText(const char* p_text, unsigned int p_color);
...
private:
	...
	CTextLineBuffer* m_lineBuffer; // 0x24
...
extern CTextWnd* g_pDebugWindow;
