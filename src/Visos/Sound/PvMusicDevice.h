...
public:
	...
	virtual void Dummy10(unsigned long p_handle) = 0;                                // vtable+0x10
	virtual void Dummy14(unsigned long p_handle) = 0;                                // vtable+0x14
	virtual void Dummy18(unsigned long p_handle) = 0;                                // vtable+0x18
	virtual void Dummy1c(unsigned long p_handle) = 0;                                // vtable+0x1c
