#ifndef LEMBALL_SCAFFOLD_VISOS_GRAPHICS_HOTAREAHANDLER_H
#define LEMBALL_SCAFFOLD_VISOS_GRAPHICS_HOTAREAHANDLER_H
...
public:
	...
	unsigned int ProcessArea(Message* p_message, const VsPoint& p_point, struct HotAreaHandler* p_currentHandler);
