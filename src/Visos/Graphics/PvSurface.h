...
public:
	...
	virtual void Blit(FilledCircle* p_circle) = 0;                        // vtable+0x1c
	virtual void Blit(Line* p_line) = 0;                                  // vtable+0x18
	virtual void Blit(Bitmap* p_primitive, ResBitmap* p_bitmap) = 0;      // vtable+0x14
	virtual void Blit(ClipRect* p_arg0) = 0;                              // vtable+0x10
	virtual void Blit(Circle* p_circle) = 0;                              // vtable+0x0c
	virtual void Blit(BigBitmap* p_arg0, ResBitmap* p_arg1) = 0;          // vtable+0x08
	virtual void Blit(SolidRect* p_rect) = 0;                             // vtable+0x04
