...
void CPvButton::InternalDrawButton()
{
...
void CPvButton::InternalOnReleased(int p_flags)
{
	Message posted;
	int converted;
...
void CPvButton::InternalOnPressed(int p_flags)
{
	Message posted;
	int converted;
...
void CPvButton::InternalOnEnterButton()
{
	Message posted;
...
void CPvButton::InternalOnExitButton()
{
	Message posted;
