...
void Wnd::OnZoomInternal(int p_oldZoom)
{
	RECT windowRect;
	RECT clientRect;

	PvWnd::OnZoomInternal(p_oldZoom);
...
void Wnd::SetRectInternal(const VsRect& p_rect)
{
}

// 68K 0x10111a0a _SetRelTL__4CWndFRC8CVSPoint
// FUNCTION: LEMBALL 0x00465a00
void Wnd::SetRelativeTopLeftInternal(const VsPoint& p_point)
{
