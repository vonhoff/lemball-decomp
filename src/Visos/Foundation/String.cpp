...
// STUB: LEMBALL 0x0046e410
String::String()
{
}

// 68K 0x10200ec4 __ct__7CStringFPc
// STUB: LEMBALL 0x0046e430
String::String(char* p_arg0)
{
}
...
// STUB: LEMBALL 0x0046e570
String& String::operator=(char* p_text)
{
	return *(String*) 0;
}
