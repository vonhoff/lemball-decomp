...
// STUB: LEMBALL 0x00451d20
unsigned int PasswordDrawer::ButtonNumeric(int p_button)
{
	return 0;
}

// 68K 0x1080d266 DrawButtons__15CPasswordDrawerFv
// STUB: LEMBALL 0x00451e40
