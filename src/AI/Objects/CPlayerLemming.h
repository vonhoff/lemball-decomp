...
// SIZE 0x22c
// VTABLE: LEMBALL 0x00493890 CGlobalGameObject
// VTABLE: LEMBALL 0x00493870 CNetworkMessage
class CPlayerLemming : public CGlobalGameObject, public CNetworkMessage {
public:
...
private:
	...
	CPlayerLemmingGroup* m_group;                               // 0x224
	unsigned short m_ammoCount;                                 // 0x228
};

// SYNTHETIC: LEMBALL 0x00410b20
// CPlayerLemming::`scalar deleting destructor'

// SYNTHETIC: LEMBALL 0x00410b70
// CPlayerLemming::`vector deleting destructor'
