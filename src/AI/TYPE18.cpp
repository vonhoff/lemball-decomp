...
DECOMP_SIZE_ASSERT(LevelType18ChunkStream, 0x54);
...
extern int PASCAL return_false_vtable_callback_0040ab80(void* pUnused1, void* pUnused2, void* pUnused3);
...
struct LevelType18ChunkStreamEntry {
	char m_abPayload[0x4c];
};

class LevelType18ChunkObject {
public:
	virtual void* Delete(BYTE fDelete) = 0;
	virtual void Reserved01(void) = 0;
	virtual void Reserved02(void) = 0;
	virtual void EmitRenderEntry(LevelType18ChunkStreamEntry* pOutput) = 0;
	...
	virtual int HandleChunkStreamCommand(unsigned short nCommand, LevelType18ChunkStream* pStream) = 0;
...
class LevelEffChunkStreamVirtualInterface {
public:
	...
	virtual void Reserved18(void) = 0;
	virtual void Reserved1C(void) = 0;
	virtual int HandleUnhandledChunkStreamCommand(unsigned short nCommand,
												  LevelType18ChunkObject* pObject,
												  LevelType18ChunkStream* pStream) = 0;
	virtual int Reserved24(void) = 0;
};

void LEMBALL_FASTCALL DispatchType18ChunkStreamCommands(LevelType18ChunkStream* pStream);
void LEMBALL_FASTCALL ResetType18ChunkStreamObjects(LevelType18ChunkStream* pStream);
void LEMBALL_FASTCALL PrepareType18ChunkStreamObjects(LevelType18ChunkStream* pStream);
void* LEMBALL_FASTCALL DeleteType18ChunkStream(LevelType18ChunkStream* pStream, void* pUnused, BYTE fDelete);

void* LEMBALL_FASTCALL DeleteType18ChunkStreamThunk(LevelType18ChunkStream* pStream, void* pUnused, BYTE fDelete);
int PASCAL ReturnFalseChunkStreamRenderThunk(void* pUnused);
void* LEMBALL_FASTCALL DeleteLevelEffChunkStreamBaseThunk(void* pObject, void* pUnused, BYTE fDelete);
unsigned short LEMBALL_FASTCALL GetManagedEntitySlotIdThunk(int nManagedEntityObject);
void* LEMBALL_FASTCALL DeleteEffStreamConstructionBaseThunk(void* pObject, void* pUnused, BYTE fDelete);
void LEMBALL_FASTCALL DestroyType18ChunkStreamThunk(LevelType18ChunkStream* pStream);
void LEMBALL_FASTCALL DispatchType18ChunkStreamCommandsThunk(LevelType18ChunkStream* pStream);
LevelType18ChunkStream* LEMBALL_FASTCALL ConstructType18ChunkStreamThunk(LevelType18ChunkStream* pStream);
int LEMBALL_FASTCALL EmitType18ChunkStreamEntriesThunk(LevelType18ChunkStream* pStream, void* pUnused, void* pOutput);
void LEMBALL_FASTCALL PrepareType18ChunkStreamObjectsThunk(LevelType18ChunkStream* pStream);
void LEMBALL_FASTCALL ResetType18ChunkStreamObjectsThunk(LevelType18ChunkStream* pStream);
int PASCAL ReturnFalseChunkStreamCommandThunk(void* pUnused1, void* pUnused2, void* pUnused3);
...
void* LEMBALL_FASTCALL DeleteLevelEffChunkStreamBase(void* pObject, void* pUnused, BYTE fDelete);
void* LEMBALL_FASTCALL DeleteEffStreamConstructionBase(void* pObject, void* pUnused, BYTE fDelete);
void LEMBALL_FASTCALL DispatchType18ChunkStreamCommands(LevelType18ChunkStream* pStream);
LevelType18ChunkStream* LEMBALL_FASTCALL ConstructType18ChunkStream(LevelType18ChunkStream* pStream);
void LEMBALL_FASTCALL ResetType18ChunkStreamObjects(LevelType18ChunkStream* pStream);
void LEMBALL_FASTCALL DestroyType18ChunkStream(LevelType18ChunkStream* pStream);
void LEMBALL_FASTCALL PrepareType18ChunkStreamObjects(LevelType18ChunkStream* pStream);
void* LEMBALL_FASTCALL DeleteType18ChunkStream(LevelType18ChunkStream* pStream, void* pUnused, BYTE fDelete);
...
// LINKERILT: LEMBALL 0x004012b7
int PASCAL ReturnFalseChunkStreamRenderThunk(void* pUnused)
{
	return return_false_vtable_callback_0040ab90(pUnused);
}

// LINKERILT: LEMBALL 0x00401645
void* LEMBALL_FASTCALL DeleteLevelEffChunkStreamBaseThunk(void* pObject, void* pUnused, BYTE fDelete)
...
// LINKERILT: LEMBALL 0x00401794
unsigned short LEMBALL_FASTCALL GetManagedEntitySlotIdThunk(int nManagedEntityObject)

{
	return ((CGameObject*) nManagedEntityObject)->GetId();
}

// LINKERILT: LEMBALL 0x00401aaa
void* LEMBALL_FASTCALL DeleteEffStreamConstructionBaseThunk(void* pObject, void* pUnused, BYTE fDelete)
...
// LINKERILT: LEMBALL 0x0040280b
int LEMBALL_FASTCALL EmitType18ChunkStreamEntriesThunk(LevelType18ChunkStream* pStream, void* pUnused, void* pOutput)

{
	(void) pUnused;
	return pStream->EmitEntries((LevelType18ChunkStreamEntry*) pOutput);
}

// LINKERILT: LEMBALL 0x00402a90
void LEMBALL_FASTCALL PrepareType18ChunkStreamObjectsThunk(LevelType18ChunkStream* pStream)
...
// LINKERILT: LEMBALL 0x00402dfb
int PASCAL ReturnFalseChunkStreamCommandThunk(void* pUnused1, void* pUnused2, void* pUnused3)

{
	return return_false_vtable_callback_0040ab80(pUnused1, pUnused2, pUnused3);
}

// LINKERILT: LEMBALL 0x00402e23
void NoopType18ChunkStreamWriteThunk(void)
{
	noop_vtable_callback_0040adc0();
}

// LINKERILT: LEMBALL 0x00403427
void NoopLevelEffChunkStreamVirtualThunk(void)
{
...
{
	LevelType18ChunkObject* pObject;
	LevelType18ChunkObject* pCandidate;
	unsigned int i;
	unsigned short nCommand;
	unsigned short nSlotId;

	nCommand = ((CNetworkMessage*) pStream)->ReadEffStreamU16BEValue();
	while (nCommand != 0x2f) {
		nSlotId = ((CNetworkMessage*) pStream)->ReadEffStreamU16BEValue();
		pObject = 0;
		i = 0;
		if (0 < g_GAME_ManagedEntityRegistryCount) {
			do {
				pCandidate =
					(LevelType18ChunkObject*) (unsigned long) g_GAME_ManagedEntityRegistryTable[(unsigned short) i];
				if (pCandidate != 0 && GetManagedEntitySlotIdThunk((int) (unsigned long) pCandidate) == nSlotId) {
					pObject = pCandidate;
					break;
				}
				++i;
			} while ((int) i < (int) (unsigned int) g_GAME_ManagedEntityRegistryCount);
		}
		if (pObject->HandleChunkStreamCommand(nCommand, pStream) == 0) {
			((LevelEffChunkStreamVirtualInterface*) pStream)
				->HandleUnhandledChunkStreamCommand(nCommand, pObject, pStream);
		}
		nCommand = ((CNetworkMessage*) pStream)->ReadEffStreamU16BEValue();
	}
}
...

{
	...
	pStream->m_pVtable = (GameEffStreamVtable*) g_LEVEL_EffChunkStreamBaseVtable;
	if (g_pActiveNetworkRuntimeWindow != 0) {
		pStream->m_fHasPayload = 1;
		pStream->m_cbSerializedLength += g_cbEffTransportMaxPacketBytes;
	}
	pStream->m_pVtable = (GameEffStreamVtable*) g_LEVEL_Type18ChunkStreamVtable;
...
{
	LevelType18ChunkObject** ppObject;
	int i;
...

{
	...
	((CNetworkMessage*) pStream)->DestroyEffStreamBase();
}

// FUNCTION: LEMBALL 0x0040c890
int LevelType18ChunkStream::EmitEntries(LevelType18ChunkStreamEntry* pEntry)

{
	...
	if (0 < m_cObjects50) {
		...
		do {
			if ((*ppObject)->m_nStateB8 != 0x18 && (*ppObject)->m_nStateB8 != 0x1e) {
...
void* LEMBALL_FASTCALL DeleteLevelChunkObjectBaseScalarB(void* pObject, void*, BYTE fDelete)
{
...
extern void LEMBALL_FASTCALL DestroyLevelChunkStreamAutoThunk(void* pObject);

void* LEMBALL_FASTCALL DeleteLevelChunkStreamAuto(void* pObject, void*, BYTE fDelete)
{
	DestroyLevelChunkStreamAutoThunk(pObject);
	if ((fDelete & 1) != 0) {
		FreeVSMemBlock(pObject);
	}
	return pObject;
