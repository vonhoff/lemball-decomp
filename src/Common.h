...
class GunButtons;
class GunController;
class GunControllerJunction;
class HiliteButtons;
class HiliteController;
class HiliteControllerJunction;
class HiliteWindow;
...
class Flag;
class Frames;
class FrontendFlow10Process;
class FrontendPrimitiveRecord;
...
class InvisibleSwitchTarget;
class Key;
class LemmingAnimsLoadSubobject;
class LevelLoader;
class Lift;
class LiftEndpointRecord;
class LiftManager;
class LoadBlockHeader;
class Main2DDisplay;
class MainOptions1;
