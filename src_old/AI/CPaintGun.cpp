...
// Mac blueprint: CPaintGun::Set(ushort, CPoint-like fixed-point point, int subtype)

// FUNCTION: LEMBALL 0x0042bb30
void CPaintGun::Set(unsigned short nSlot, const int* pPoint, int nSubtype)
{
	...
	*(int*) (pObjectBytes + 0x140) = nSubtype;
