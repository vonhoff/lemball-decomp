...
#define GET_ZRLE_SOURCE(pStream) ((unsigned char*(__fastcall*) (void*) )(*(void***) (pStream))[0x28 / 4])((pStream))
...
void __fastcall decode_zrle_rows_clipped(void* pThis,
										 int nUnusedEdx,
										 short* param_1,
										 int param_2,
										 int* param_3,
										 int param_4)
{
	...
	if (param_4 == 0) {
		...
		nSkipRows = ((int) *(short*) ((char*) param_3 + 0x4e) - (int) *(short*) (param_2 + 6)) - (int) param_1[1];
	}
	...
	if (param_1[1] > 0) {
		...
		do {
			...
			pDst = (unsigned char*) (*(int*) (*(int*) ((char*) pThis + 4) + nRowOffset) + (int) sDestinationX);
...
void __fastcall decode_zrle_rows_clipped_write_mask(void* pThis,
													int nUnusedEdx,
													short* param_1,
													int param_2,
													int* param_3,
													unsigned short param_4)
{
	...
	sDestinationX = param_1[2];
	nMaskPattern = (unsigned int) param_4 | ((unsigned int) param_4 << 16);
	nRow = 0;
	if (param_1[1] > 0) {
		...
		do {
			nRemaining = (int) param_1[0];
			nLeft = (int) *(short*) (param_2 + 4);
			pMask = (unsigned short*) (*(int*) (*(int*) ((char*) pThis + 0x50) + nRowOffset) + (int) sDestinationX * 2);
			pDst = (unsigned char*) (*(int*) (*(int*) ((char*) pThis + 4) + nRowOffset) + (int) sDestinationX);
						...
						if (nCopy > 0) {
							...
							for (n = nCopy & 1; n != 0; --n) {
								*(unsigned short*) pMaskDword = param_4;
								pMaskDword = (unsigned int*) ((char*) pMaskDword + 2);
							}
						}
