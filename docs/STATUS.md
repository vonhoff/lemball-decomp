...
CGameObject is a fully-modeled class (src/AI/CGameObject.h, sizeof 0x124). **ctor (0x414F30) is best next target** — mechanical field-init (bounds +0x20/0x24=-1, +0x14-1c=0, sentinel 0xaa55aa55 on coords, vtable 0x493c40, m_nEntityType64=arg1) + m_pCommandQueue70 route-array (alloc nCount*0x14 via 0x45a780, ctor each via ILT 0x401c08→0x417ab0, stride 0x14) + object-table reg (0x4a6510[] by count 0x4a74bc, slot in m_nSlotId6C). Needs CGameObjectBounds/CGameObjectCommandQueue sub-types. Other CGameObject gaps (Move/StartMoving/SearchRoute/MapCheck/AlterDestination/StartLand) are movement/search heavy. Singles: NoOfLevelsInSkill(0x408F30 switch), CPVButton ctor(0x467C10), sort trio VSQSort/shortsort/swap(0x463960-0x463B20).
