...
| `AI` | `CDoor`, `CDoorManager`, `CIce`, `CIceManager`; remaining game objects, players, enemies | `src/AI/CDoorAct.cpp`, `CDoorSlot.cpp`, `CDoorCtor.cpp`, `CIceAct.cpp`; mixed Windows owners retained elsewhere | High for the Door and Ice correlations; `LINKSCF.CPP` remains a 296-function mixed Windows owner |
