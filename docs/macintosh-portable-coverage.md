...
| --- | ---: | --- |
| Accepted x86 correlation | 1301 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 653 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 224 | 8 | 0 | 1 | 393 | 626 |
