...
| --- | ---: | --- |
| Accepted x86 correlation | 1319 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 635 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 242 | 8 | 0 | 1 | 375 | 626 |
