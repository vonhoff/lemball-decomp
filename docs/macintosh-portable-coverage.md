...
| --- | ---: | --- |
| Accepted x86 correlation | 1269 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 685 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 192 | 8 | 0 | 1 | 425 | 626 |
