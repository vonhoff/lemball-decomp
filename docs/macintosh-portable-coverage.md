...
| --- | ---: | --- |
| Accepted x86 correlation | 1254 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 699 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 177 | 8 | 1 | 1 | 439 | 626 |
