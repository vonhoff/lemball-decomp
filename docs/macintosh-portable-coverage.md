...
| --- | ---: | --- |
| Accepted x86 correlation | 1362 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 589 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 285 | 1 | 10 | 1 | 329 | 626 |
