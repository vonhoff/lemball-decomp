...
| --- | ---: | --- |
| Accepted x86 correlation | 1149 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 806 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 72 | 8 | 0 | 0 | 546 | 626 |
