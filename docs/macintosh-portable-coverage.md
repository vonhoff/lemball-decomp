...
| --- | ---: | --- |
| Accepted x86 correlation | 1288 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 666 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 211 | 8 | 0 | 1 | 406 | 626 |
