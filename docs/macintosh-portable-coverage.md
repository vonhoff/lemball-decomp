...
| --- | ---: | --- |
| Accepted x86 correlation | 1195 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 759 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 118 | 8 | 0 | 1 | 499 | 626 |
