...
| --- | ---: | --- |
| Accepted x86 correlation | 1343 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 611 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 266 | 8 | 0 | 1 | 351 | 626 |
