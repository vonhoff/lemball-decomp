...
| --- | ---: | --- |
| Accepted x86 correlation | 1368 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 584 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 291 | 0 | 10 | 1 | 324 | 626 |
