...
| --- | ---: | --- |
| Accepted x86 correlation | 1266 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 688 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 189 | 8 | 0 | 1 | 428 | 626 |
