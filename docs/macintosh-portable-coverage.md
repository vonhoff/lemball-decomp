...
| Likely inlined/merged | 12 | Exact scoped header definition or split Windows implementation exists, but no standalone x86 address is accepted. |
...
| Genuinely missing/unresolved | 590 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 285 | 1 | 9 | 1 | 330 | 626 |
