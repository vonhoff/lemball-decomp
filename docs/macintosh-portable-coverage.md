...
| --- | ---: | --- |
| Accepted x86 correlation | 1080 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 871 | No accepted address and no exact scoped source spelling. |
