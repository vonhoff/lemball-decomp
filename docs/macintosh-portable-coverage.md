...
| --- | ---: | --- |
| Accepted x86 correlation | 1232 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 722 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 155 | 8 | 0 | 1 | 462 | 626 |
