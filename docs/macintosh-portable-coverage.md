...
| --- | ---: | --- |
| Accepted x86 correlation | 1150 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 805 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 73 | 8 | 0 | 0 | 545 | 626 |
