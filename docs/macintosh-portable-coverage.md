...
| --- | ---: | --- |
| Accepted x86 correlation | 1181 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 773 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 104 | 8 | 0 | 1 | 513 | 626 |
