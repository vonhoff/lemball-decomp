...
| --- | ---: | --- |
| Accepted x86 correlation | 934 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 1018 | No accepted address and no exact scoped source spelling. |
