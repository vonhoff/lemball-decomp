...
| --- | ---: | --- |
| Accepted x86 correlation | 1321 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 633 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 244 | 8 | 0 | 1 | 373 | 626 |
