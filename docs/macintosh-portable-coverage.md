...
| --- | ---: | --- |
| Accepted x86 correlation | 1141 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 814 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 64 | 8 | 0 | 0 | 554 | 626 |
