...
| --- | ---: | --- |
| Accepted x86 correlation | 1258 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 696 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 181 | 8 | 0 | 1 | 436 | 626 |
