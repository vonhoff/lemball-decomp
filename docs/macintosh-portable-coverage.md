...
| --- | ---: | --- |
| Accepted x86 correlation | 1169 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 785 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 92 | 8 | 0 | 1 | 525 | 626 |
