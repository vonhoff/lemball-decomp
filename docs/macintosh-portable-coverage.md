...
| --- | ---: | --- |
| Accepted x86 correlation | 1147 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 808 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 70 | 8 | 0 | 0 | 548 | 626 |
