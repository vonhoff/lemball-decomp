...
| --- | ---: | --- |
| Accepted x86 correlation | 1032 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 919 | No accepted address and no exact scoped source spelling. |
