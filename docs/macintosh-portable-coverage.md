...
| --- | ---: | --- |
| Accepted x86 correlation | 1275 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 679 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 198 | 8 | 0 | 1 | 419 | 626 |
