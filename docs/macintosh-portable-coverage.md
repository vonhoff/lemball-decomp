...
| --- | ---: | --- |
| Accepted x86 correlation | 1294 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 660 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 217 | 8 | 0 | 1 | 400 | 626 |
