...
| --- | ---: | --- |
| Accepted x86 correlation | 1272 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 682 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 195 | 8 | 0 | 1 | 422 | 626 |
