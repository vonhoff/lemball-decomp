...
| --- | ---: | --- |
| Accepted x86 correlation | 1309 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 645 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 232 | 8 | 0 | 1 | 385 | 626 |
