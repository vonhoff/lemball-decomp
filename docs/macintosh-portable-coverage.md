...
| --- | ---: | --- |
| Accepted x86 correlation | 1283 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 671 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 206 | 8 | 0 | 1 | 411 | 626 |
