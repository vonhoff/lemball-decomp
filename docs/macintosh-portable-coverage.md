...
| --- | ---: | --- |
| Accepted x86 correlation | 850 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 1108 | No accepted address and no exact scoped source spelling. |
