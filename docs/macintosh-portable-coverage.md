...
| --- | ---: | --- |
| Accepted x86 correlation | 1252 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 701 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 175 | 8 | 1 | 1 | 441 | 626 |
