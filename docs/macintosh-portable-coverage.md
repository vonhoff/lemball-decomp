...
| --- | ---: | --- |
| Accepted x86 correlation | 1176 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 778 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 99 | 8 | 0 | 1 | 518 | 626 |
