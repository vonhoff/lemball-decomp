...
| --- | ---: | --- |
| Accepted x86 correlation | 1336 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 618 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 259 | 8 | 0 | 1 | 358 | 626 |
