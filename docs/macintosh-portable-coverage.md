...
| --- | ---: | --- |
| Accepted x86 correlation | 1192 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 762 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 115 | 8 | 0 | 1 | 502 | 626 |
