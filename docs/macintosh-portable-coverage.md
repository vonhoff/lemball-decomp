...
| --- | ---: | --- |
| Accepted x86 correlation | 1207 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 747 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 130 | 8 | 0 | 1 | 487 | 626 |
