...
| --- | ---: | --- |
| Accepted x86 correlation | 1356 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 596 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 279 | 8 | 2 | 1 | 336 | 626 |
