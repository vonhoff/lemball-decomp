...
| --- | ---: | --- |
| Accepted x86 correlation | 1305 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 649 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 228 | 8 | 0 | 1 | 389 | 626 |
