...
| --- | ---: | --- |
| Accepted x86 correlation | 1260 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 694 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 183 | 8 | 0 | 1 | 434 | 626 |
