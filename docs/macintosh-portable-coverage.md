...
| --- | ---: | --- |
| Accepted x86 correlation | 1278 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 676 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 201 | 8 | 0 | 1 | 416 | 626 |
