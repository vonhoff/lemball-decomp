...
| --- | ---: | --- |
| Accepted x86 correlation | 1185 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 769 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 108 | 8 | 0 | 1 | 509 | 626 |
