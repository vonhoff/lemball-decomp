...
| --- | ---: | --- |
| Accepted x86 correlation | 1158 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 796 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 81 | 8 | 0 | 1 | 536 | 626 |
