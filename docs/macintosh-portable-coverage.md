...
| --- | ---: | --- |
| Accepted x86 correlation | 1190 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 764 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 113 | 8 | 0 | 1 | 504 | 626 |
