...
| --- | ---: | --- |
| Accepted x86 correlation | 1263 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 691 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 186 | 8 | 0 | 1 | 431 | 626 |
