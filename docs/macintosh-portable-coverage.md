...
| --- | ---: | --- |
| Accepted x86 correlation | 1215 | Exact Macintosh module+mangled spelling has a reviewed x86 mapping; offset integrity is reported separately. |
...
| Genuinely missing/unresolved | 739 | No accepted address and no exact scoped source spelling. |
...
| Visos (Generic) | 138 | 8 | 0 | 1 | 479 | 626 |
