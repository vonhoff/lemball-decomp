#!/usr/bin/env python3
"""Silence warning C4786 in VC 4.20's C2.EXE.

Adapted from the LEGO Island decomp tooling:
https://github.com/isledecomp/isle/blob/master/tools/patch_c2.py
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        allow_abbrev=False,
        description="Silence warning C4786 in VC 4.20 C2.EXE during decomp builds.",
    )
